...
- **Goed (8):** Werkt volgens geplande stappen naar onderbouwde conclusies en verwerkt nieuwe inzichten
- **Voldoende (6):** Werkt volgens geplande stappen naar onderbouwde conclusies
- **Onvoldoende (4-):** Ongestructureerde analyseaanpak leidt tot weinig bruikbare conclusies

##### Initiatief (Grip, sturing, omgaan met risico's, creativiteit)
- **Uitstekend (9+):** Is uit zichzelf weinig geneigd eerst te analyseren voordat keuzes worden gemaakt en conclusies worden getrokken
- **Goed (8):** Analyseert uit zichzelf voordat keuzes worden gemaakt en conclusies worden getrokken; betrekt stakeholders
- **Voldoende (6):** Analyseert uit zichzelf voordat keuzes worden gemaakt en conclusies worden getrokken
- **Onvoldoende (4-):** Is uit zichzelf weinig geneigd eerst te analyseren voordat keuzes worden gemaakt en conclusies worden getrokken

##### Keuzes maken (Bronnen, methoden, technieken)
- **Uitstekend (9+):** Verzamelt alternatieven, onderzoekt de impact, maakt doordachte keuzes; blijft gemaakte keuzes valideren
- **Goed (8):** Verzamelt alternatieven, onderzoekt de impact en maakt goed onderbouwde keuzes
- **Voldoende (6):** Verzamelt alternatieven, onderzoekt de impact en maakt keuzes
- **Onvoldoende (4-):** Toont weinig vaardigheid in het maken van geschikte keuzes

##### Effectiviteit (Mate van bijdrage aan de oplossing van de gegeven situatie)
- **Uitstekend (9+):** Analyseert en doorgrondt relevante aspecten van de gegeven situatie, houdt rekening met toekomstige ontwikkelingen
- **Goed (8):** Analyseert en doorgrondt relevante aspecten van de gegeven situatie
...
2. Analyse van Maximo data model en API capabilities
3. Analyse van alternatieven (Openpyxl vs Pandas)
4. Impact analyse van technologiekeuzes
5. Stakeholder analyse (Matthijs, Rick, maintenance engineers)
...
- **Goed (8):** Werkt volgens geplande stappen naar onderbouwde adviezen en verwerkt nieuwe inzichten
- **Voldoende (6):** Werkt volgens geplande stappen naar onderbouwde adviezen
- **Onvoldoende (4-):** Ongestructureerde aanpak leidt tot weinig bruikbare adviezen

##### Initiatief (Grip, sturing, omgaan met risico's)
- **Uitstekend (9+):** Geeft uit zichzelf onderbouwde en bruikbare adviezen, creëert draagvlak; laat adviseren op de agenda komen en laat adviseren op de agenda komen of daarvan draagvlak te creëren
- **Goed (8):** Geeft uit zichzelf onderbouwde en bruikbare adviezen, creëert draagvlak
- **Voldoende (6):** Geeft uit zichzelf onderbouwde en bruikbare adviezen
- **Onvoldoende (4-):** Is uit zichzelf weinig geneigd onderbouwde adviezen te geven of daarvan draagvlak te creëren
...
##### Effectiviteit (Mate van bijdrage aan de oplossing van de gegeven situatie)
- **Uitstekend (9+):** Houdt rekening met eisen en wensen, geeft een uitvoerbaar en gedragen advies en houdt rekening met toekomstige ontwikkelingen
- **Goed (8):** Houdt rekening met eisen en wensen en geeft een uitvoerbaar en gedragen advies
...
2. Advies over best practices voor Excel parsing (Openpyxl)
3. Advies over Maximo API strategie (REST vs SOAP)
4. Advies over error handling aanpak
5. Aanbevelingen voor toekomstige MSG-3 template verbetering
...
- **Voldoende (6):** Ontwerpt volgens geplande stappen bruikbare oplossingen
- **Onvoldoende (4-):** Ongestructureerde ontwerpenaanpak leidt tot weinig bruikbare oplossingen

##### Initiatief (Grip, sturing, omgaan met risico's)
- **Uitstekend (9+):** Ontwerpt uit zichzelf om oplossingen te verkennen en te kiezen; stemt regelmatig met stakeholders af
- **Goed (8):** Ontwerpt uit zichzelf om oplossingen te verkennen en te kiezen; stemt regelmatig met stakeholders af
- **Voldoende (6):** Ontwerpt uit zichzelf om oplossingen te verkennen en te kiezen
- **Onvoldoende (4-):** Is uit zichzelf weinig geneigd geschikte oplossingen te ontwerpen
...
##### Effectiviteit (Mate van bijdrage aan de oplossing van de gegeven situatie)
- **Uitstekend (9+):** Maakt voldoende gedetailleerde en realiseerbare ontwerpen die voldoen aan eisen en wensen, goed communiceerbaar en toekomstbestendig zijn
- **Goed (8):** Maakt voldoende gedetailleerde en realiseerbare ontwerpen die voldoen aan eisen en wensen en goed communiceerbaar zijn
...
2. Data flow design (van Excel naar Maximo)
3. Error handling strategie
4. Business rules engine design (80 validatie regels)
5. API integration design (Maximo REST API)
...
- **Voldoende (6):** Realiseert volgens geplande stappen bruikbare oplossingen
- **Onvoldoende (4-):** Ongestructureerde aanpak leidt tot weinig bruikbare oplossingen

##### Initiatief (Grip, sturing, omgaan met risico's)
- **Uitstekend (9+):** Werkt uit zichzelf aan het realiseren van geschikte oplossingen en stemt regelmatig af met stakeholders
- **Goed (8):** Werkt uit zichzelf aan het realiseren van geschikte oplossingen en stemt regelmatig af met stakeholders
- **Voldoende (6):** Werkt uit zichzelf aan het realiseren van geschikte oplossingen
- **Onvoldoende (4-):** Is uit zichzelf weinig geneigd geschikte oplossingen te realiseren
...
##### Effectiviteit (Mate van bijdrage aan de oplossing van de gegeven situatie)
- **Uitstekend (9+):** Realiseert oplossingen die voldoen aan eisen, wensen en ontwerpen en valideert deze
- **Goed (8):** Realiseert oplossingen die voldoen aan eisen, wensen en ontwerpen en valideert deze
...
2. Business rules validator (80 regels geïmplementeerd)
3. Maximo API connector (REST integratie)
4. Change detection algoritme (vergelijkt versies)
5. Comprehensive test suite (unit + integration tests)
...
- **Goed (8):** Werkt volgens geplande stappen aan het beheren, monitoren en optimaliseren van ICT-systemen en/of organisatieprocessen; en verwerkt nieuwe inzichten
...
- **Onvoldoende (4-):** Ongestructureerde aanpak leidt tot weinig grip en sturing in het beheren, monitoren en optimaliseren van ICT-systemen en/of organisatieprocessen

##### Initiatief (Grip, sturing, omgaan met risico's)
- **Uitstekend (9+):** Beheert, monitort en optimaliseert uit zichzelf, in regelmatig overleg met stakeholders, de ontwikkeling, ingebruikname en/of gebruik van ICT-systemen en/of organisatieprocessen
- **Goed (8):** Beheert, monitort en optimaliseert uit zichzelf, in regelmatig overleg met stakeholders, de ontwikkeling, ingebruikname en/of gebruik van ICT-systemen en/of organisatieprocessen
- **Voldoende (6):** Beheert, monitort en optimaliseert uit zichzelf de ontwikkeling, ingebruikname en/of gebruik van ICT-systemen en/of organisatieprocessen
- **Onvoldoende (4-):** Is uit zichzelf weinig geneigd de ontwikkeling, ingebruikname en/of ICT-systemen en/of organisatieprocessen te beheren, monitoren en optimaliseren
...
##### Effectiviteit (Mate van bijdrage aan de oplossing van de gegeven situatie)
- **Uitstekend (9+):** Zorgt voor een overdracht van de oplossing die voldoet aan eisen, wensen van de opdrachtgever, valideert deze en maakt deze toekomstbestendig
- **Goed (8):** Zorgt voor een overdracht van de oplossing die voldoet aan eisen, wensen van de opdrachtgever en valideert deze
...
2. Risicomanagement (geïdentificeerd en gemitigeerd)
3. Kwaliteitsborging (testing, code reviews)
4. Stakeholder management (Matthijs, Rick, coach)
5. Versie controle (Git, proper branching)
6. Documentatie voor overdracht (gebruikers + tech handleiding)
...
- **Goed (8):** Overtreft verwachtingen
- **Voldoende (6):** Voldoet aan verwachtingen
- **Onvoldoende (4-):** Voldoet niet aan verwachtingen
...
#### 1A. Ondernemend zijn
**Sleutelwoord:** *Persoonlijk leiderschap - ondernemend zijn*

**Voldoende (6):**
- Is proactief, maar een enkele keer afwachtend en afhankelijk
- Stelt uitdagende doelen en prioriteiten
...
#### 1B. Professionele ontwikkeling
**Sleutelwoord:** *Persoonlijk leiderschap - professionele ontwikkeling*

**Voldoende (6):**
- Reflecteert op eigen handelen, denken en resultaten
- Benoemt de effecten daarvan

**Goed (8):**
- Reflecteert diepgaand op eigen handelen, denken en resultaten
- Benoemt de effecten daarvan en stelt handelingen/acties bij
...
#### 2A. Normen en waarden, ethische dilemma's, cultuurverschillen
**Sleutelwoord:** *Toekomstgericht organiseren - normen en waarden, ethische dilemma's, omgaan met cultuurverschillen*

**Voldoende (6):**
- Houdt rekening met normen en waarden van de omgeving
- Is zich bewust van beroepsmatige en ethische dilemma's
- Toont respect voor cultuurverschillen
- Handelt in overeenstemming met normen en waarden van de omgeving
...
**Uitstekend (9+):**
- Gaat bewust om met beroepsmatige en ethische dilemma's
- Toont respect en inlevingsvermogen bij culturele verschillen
- Handelt ethisch
...
#### 2B. Organisatorische context, managen
**Sleutelwoord:** *Toekomstgericht organiseren - Organisatorische context, managen*
...
### 3. Onderzoekend Probleemoplossend

**Sleutelwoord:** *Onderzoekend probleemoplossen*

**Voldoende (6):**
- Zoekt nieuwe kennis, analyseert en doorziet problemen

**Goed (8):**
- Zoekt nieuwe kennis, analyseert en doorziet problemen
- Laat een win-win houding zien en werkt effectief samen
- Ontvangt feedback en doet dit op constructieve wijze

**Uitstekend (9+):**
- Onderzoekt passende, originele oplossingen en mogelijkheden
...
### 4. Doelgericht Interacteren

#### 4A. Partner in samenwerking, win-win, feedback, leiderschap
**Sleutelwoord:** *Doelgericht interacteren - partner in samenwerking, win-win situaties, feedback en leiderschap*
...
#### 4B. Effectief communiceren
**Sleutelwoord:** *Doelgericht interacteren - effectief communiceren, geschikte communicatievormen en -middelen*

**Voldoende (6):**
- Communiceert effectief in het Nederlands (en Engels)
- Gebruikt gangbare communicatievormen en -middelen

**Goed (8):**
- Communiceert effectief in het Nederlands (en Engels)
- Gebruikt geschikte communicatievormen en -middelen
...
**Voorbeeld in Reflectieverslag:**
> "Voor de competentie **Analyseren** verwijs ik naar mijn analyse van de MSG-3 structuur (docs/onderzoek/01-msg3-analyse.md) waarin ik 80 business rules heb geïdentificeerd..."
...
Voor niveau 2 (Realiseren): toon ook zelfstandigheid en diepgang

### 4. Zichtbaar maken
Assessoren moeten bewijs KUNNEN VINDEN. Zorg voor:
- Duidelijke bestandsnamen
- Inhoudsopgave in documenten
- Cross-references tussen documenten
- README in je oplevering

### 5. Professional Skills
Let op "gedrag" voorbeelden:
- Hoe reageerde je op feedback?
- Hoe loste je problemen op?
- Hoe communiceerde je met stakeholders?
- Toon dit in reflectie en sprint retrospectives

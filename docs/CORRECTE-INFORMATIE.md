...
**Primaire Stagebegeleider:**
- Naam: Matthijs Meijer
- Functie: Sr. Maintenance Engineer
- Rol: Functionele requirements, business rules, Maximo toegang

**Secundaire Stagebegeleider:**
- Naam: Rick Kramer
- Functie: Maintenance Service Coordinator
- Rol: Proces, stakeholders, feedback

**Code Support Team:**
- Jasper van Polen - Data Analyst (Technische hulp)
- Fajjaaz Chandoe - Data Analyst (Technische hulp)

### Windesheim

**Stage Coach:**
- Naam: Arie Ismael
- Rol: Documentatie tips, coaching, bedrijfsbegeleider
...
```markdown
_Pedro Eduardo Cardoso - ADSD Student - Babcock Schiphol_
```
...
- Matthijs Meijer & Rick Kramer (beide begeleiders)
...
- [ ] Opleiding: Associate Degree Software Developer (ADSD)
- [ ] Instelling: Windesheim
- [ ] Beide stagebegeleiders vermeld (Matthijs & Rick)
- [ ] Code support team vermeld (Jasper & Fajjaaz)
- [ ] Stage coach vermeld (Arie Ismael)
...
5. **Check:** Zijn Jasper & Fajjaaz vermeld als code support?

---

**Bewaar dit document als referentie!**

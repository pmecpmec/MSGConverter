...
- **Daily Progress** - Wat is gedaan per dag (5 min per dag)
- **Sprint Review** - Demo, resultaten, stakeholder feedback
- **Sprint Retrospective** - Learnings, verbeterpunten, acties
...
1. **Open:** `sprints/sprint-01-planning.md`
2. **Review:** Planning dag-voor-dag
3. **Send:** Email naar Matthijs & Rick (template in document)
4. **Start:** BAC-001 (MSG-3 analyse)
5. **Log:** Daily progress (16:45 elke dag)

**Vrijdag 28 februari - End Sprint 1:**
1. **Complete:** Sprint review sectie
2. **Complete:** Sprint retrospective
3. **Update:** ZELFEVALUATIE-TRACKING.md
4. **Send:** Sprint review email naar stakeholders
5. **Prepare:** Sprint 2 planning
...
- Sprint 2: [TBD] story points
- Sprint 3: [TBD] story points
- Average: [TBD] (update na elke sprint)
...
**Update deze metrics na elke sprint!**

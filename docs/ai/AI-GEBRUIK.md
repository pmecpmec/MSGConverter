...
- Code review en refactoring suggesties
- Test generation (unit tests, integration tests)
- Debugging assistentie
- Architecture en design patterns advies
- Markdown documentatie generatie

### Secundaire Tools
**ChatGPT** (optioneel, indien gebruikt)
- Research en ideeontwikkeling
- Technische vraagstukken verhelderen
...
### Phase 1: Projectdefinitie (Week 1-2) - NIVEAU 2 & 3

#### AIAS Niveau: **2 - AI Exploratie** (Brainstorming, planning, structuur)
#### AIAS Niveau: **3 - AI Samenwerking** (Tekst verfijning, formatting)
...
> Tijdens de voorbereiding van de projectdefinitie heb ik **Cursor AI** gebruikt om te **brainstormen over documentstructuur, SMART doelstellingen templates, en stakeholder analyse frameworks**. Ik verklaar dat het ingeleverde werk geen AI-gegenereerde inhoud bevat. De daadwerkelijke probleemstelling, doelen, scope en stakeholders zijn gebaseerd op mijn eigen analyse van de situatie bij Babcock Schiphol. Ik draag de volledige verantwoordelijkheid voor de inhoud van dit werk.

**Authenticiteitsverklaring (Niveau 3 - waar van toepassing):**
...
### Phase 2: Plan van Aanpak - NIVEAU 2 & 3

#### AIAS Niveau: **2 - AI Exploratie** (Planning structuur, risicoanalyse framework)
#### AIAS Niveau: **3 - AI Samenwerking** (Gantt chart, documenten formatting)
...
### Phase 3: Onderzoek & Technisch Ontwerp - NIVEAU 3
...
### Phase 4-7: Implementatie (Code Development) - NIVEAU 3
...
> Tijdens de implementatie van de source code heb ik **Cursor AI** gebruikt om te **genereren van code suggesties, class structures, en design pattern implementaties**. Na het gebruik van deze tool heb ik de uitkomsten ervan uitvoerig gecontroleerd en aangepast om er voor te zorgen dat het ingeleverde werk mijn eigen competenties en leeruitkomsten reflecteert. Alle business logic, error handling, en project-specifieke implementaties zijn door mij geschreven en getest. Ik draag de volledige verantwoordelijkheid voor de inhoud van dit werk.

---

### Testing (Unit & Integration Tests) - NIVEAU 3
...
> Tijdens het schrijven van tests heb ik **Cursor AI** gebruikt om te **genereren van test templates, fixture setups, en parametrized test suggesties**. Na het gebruik van deze tool heb ik de uitkomsten ervan uitvoerig gecontroleerd en aangepast om er voor te zorgen dat het ingeleverde werk mijn eigen competenties en leeruitkomsten reflecteert. Alle test assertions, edge cases, en business rule validatie tests zijn door mij gedefinieerd. Ik draag de volledige verantwoordelijkheid voor de inhoud van dit werk.
...
**ANALOGIE:**
AI is zoals Google bij research:
- Google geeft zoekresultaten → IK analyseer en pas toe
...
Het gebruik van **Cursor AI** heeft dit project significant versneld en verrijkt, met name in:
- Repository setup en structuur
- Code templates met best practices
- Testing framework en voorbeelden
- Documentatie generatie

**Echter:** Alle kritische aspecten zoals business rules, architecturale beslissingen, en project-specifieke implementaties zijn door **Pedro** zelf gedaan, met AI als ondersteunende tool.

**Eindverantwoordelijkheid:** Pedro draagt volledige verantwoordelijkheid voor alle deliverables en kan alle technische keuzes toelichten tijdens assessment.
...
## Overzicht Authenticiteitsverklaringen per Deliverable

| Deliverable | AIAS Niveau | AI-Tool | Primaire Gebruik |
|-------------|-------------|---------|------------------|
| **Projectdefinitie** | 2 & 3 | Cursor AI | Structuur, brainstorming, tekst verfijning |
| **Plan van Aanpak** | 2 & 3 | Cursor AI | Planning templates, risicoanalyse framework |
| **Onderzoek** | 3 | Cursor AI | Diagram generatie, API analyse |
| **Technisch Ontwerp** | 3 | Cursor AI | Architectuur suggesties, UML templates |
...
*Dit document wordt continu bijgewerkt tijdens het project om alle AI-gebruik transparant te documenteren.*
